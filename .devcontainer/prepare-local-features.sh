...
rm -rf "${local_features_dir}/linux-x11-forwarding" "${local_features_dir}/linux-pulseaudio-forwarding" "${local_features_dir}/ros2" "${local_features_dir}/x11" "${local_features_dir}/wayland"
cp -R "${repo_root}/features/src/linux-x11-forwarding" "${local_features_dir}/linux-x11-forwarding"
cp -R "${repo_root}/features/src/linux-pulseaudio-forwarding" "${local_features_dir}/linux-pulseaudio-forwarding"
